...
ввода и вывода данных. Используется библиотека [macrolib](Files/macrolib.s), из неё применяются print_str и newline.
