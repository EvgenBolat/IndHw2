...
- Обернул в макросы уже ранее разработанные подпрограммы read_double, print_double, F, RetX, IsCorrectInterv, и добавил к другим макросам в библиотеку [macrolib.s](Files/RISKFILES/macrolib.s).
